...
def run(
        ...
        source=ROOT / "http://192.168.55.107:8080/video",  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / default_vid_path, help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / default_vid_path, help='file/dir/URL/glob, 0 for webcam')
